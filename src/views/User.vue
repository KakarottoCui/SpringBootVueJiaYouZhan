<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="cardname" label="会员卡名称" width="140"></el-table-column>
      <el-table-column prop="discount" label="折扣(%)" width="140">
        <template slot-scope="{ row }">{{ (row.discount) }}%</template>
      </el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="折扣（1-99)">
          <el-input v-model="form.discount" autocomplete="off" type="number"></el-input>
        </el-form-item>
      </el-form>
